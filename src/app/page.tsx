      ...
      <section id="upgrade" className="py-20 px-4 border-t border-slate-800/60">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-xl mx-auto">
            <div className="bg-slate-900 border border-slate-700 rounded-xl p-6 text-left">
            ...
            <div className="bg-slate-900 border-2 border-blue-500 rounded-xl p-6 text-left relative">
